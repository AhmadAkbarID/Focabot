...
const vcard = 'BEGIN:VCARD\n'  //Jangan diganti,Ntar error
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6285187063723:+6285187063723\n'  // Ganti jadi nomormu, tapi jangan ubah polanya
...
//owner number
const ownerNumber = ["6285187063723@s.whatsapp.net"]  //Ganti Jadi Nomormu
...
//CASE BADWORD
	...
	if (!isRegistered) return reply(ind.noregis())
		...
		if (isBanned) return reply(ind.baned())
                ...
                addKoinUser('6285187063723@s.whatsapp.net', fee)
